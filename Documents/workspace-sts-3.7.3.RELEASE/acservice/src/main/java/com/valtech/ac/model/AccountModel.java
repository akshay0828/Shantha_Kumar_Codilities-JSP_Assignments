...
public class AccountModel {
	...
	public AccountModel(Account acc) {
		this(acc.getId(),acc.getAccountType(),acc.getBalance(),acc.getCreationDate(),acc.getLastUpdatedDate(),acc.isActive());
	}
	
	
	public Account getAccount() {
		return new Account(id,accountType,balance,creationDate,lastUpdatedDate,active);
